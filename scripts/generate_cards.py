...
CARD_DATA = {
    ...
    "info-056": {"title": "유치원 입학(유보통합포털)", "category": "복지",
                 "highlights": ["처음학교로→유보통합포털 통합", "우선모집 11월 초, 일반모집 중순", "일반모집 최대 3곳 지원 가능"]},
    "info-057": {"title": "꿈해몽 참고하기", "category": "라이프",
                 "highlights": ["이빨·뱀·불 꿈 등 전통 해석", "민간 속설, 과학적 근거 없음", "재미로 참고하는 정도로만"]},
}
